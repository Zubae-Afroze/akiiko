...
} from '../../components/CheckOut/FormObject'
...
export default function CheckOut() {
  const [cashOnDeliveryState, setCashOnDeliveryState] = useState(
    paymentObject.isCOD
  )
    ...
    <>
      {false ? (
        ...
        <>
          ...
          <Container
            fluid
            className='p-0 m-0 d-flex justify-content-center remove-margin'
            style={{ width: '100%' }}
          >
              ...
              <Container style={{ margin: 0, padding: 0 }}>
                ...
                >
                  <CashOnDeliveryContext.Provider
                    value={{
                      value: cashOnDeliveryState,
                      toggleCodState: toggelCODstate,
                    }}
                  >
