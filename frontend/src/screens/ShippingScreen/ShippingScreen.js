          ...
          <Card className='shipping-card'>
            {userInfo ? (
              <div className='saved-shipping-address'>
                <Card.Title className='shipping-card-title'>
                  Hello, {userInfo.name}!
                </Card.Title>
                {shippingAddress ? (
                  <div>
                    <div className='shipping-edit'>
                      <div>
                        <strong>Your Current Shipping Address</strong>
                      </div>
                    ...
                    <div>
                      <div className='shipping-edit'>
                        Please edit the address if it's empty
                      </div>
                      <div
                        className='edit-handler-main'
                        onClick={editAddressHandler}
                      >
                        <em>Edit the address</em>
                      </div>
                      {editAddress ? (
                        <div>
                      ...
                      <Form onSubmit={submitHandler}>
                        ...
                        <Form.Group>
                          <div className='no-save-button-wrap'>
                            <button type='submit' className='no-save-button'>
                              Add Address
                            </button>
                          </div>
                        </Form.Group>
