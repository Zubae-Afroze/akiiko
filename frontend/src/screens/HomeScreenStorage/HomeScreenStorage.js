...
const HomeScreenWorkout = () => {
  console.log('home screen storage')
  ...
  function NewComp() {
    return (
      <>
        <div className='storage-title-comp'>STORAGE</div>
        <div className='storage-header-comp'>
          ...
          <button className='storage-header-shop-btn'>SHOP ALL</button>
        </div>
        ...
        <div className='storage-bags-comp-main-content-wrapper'>
          <img
            className='storage-flex-img-wrapper'
  ...
  //             A thoughtful range of organisers and storage bags to compliment
  //             and increase the functionality of your home. Simplistic and warm,
  //             the colour tones and minimal design elevate the mood of your
  //             personal spaces and allow for easy declaring.{' '}
  //           </div>
  //         </Col>
  //       </Row>
  //       <Row>
