...
export default function SearchScreen() {
    ...
    return (
        <>
            ...
            {
                searchedProducts && (
                    <SearchResult searchedProducts={searchedProducts} setSearchedProducts={setSearchedProducts}/>
                )
            }
            </div>
    ...
    function onSearch(val){
        ...
        let result = products.filter(product => product.productName.toLowerCase().includes(val.target.value.toLowerCase()));
