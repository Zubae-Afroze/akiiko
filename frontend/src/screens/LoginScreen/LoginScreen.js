        ...
        <React.Fragment>
            <div className='login-wrap'>
                ...
                <div className='sign-in-web'>
                    <div className='sign-in-title'><Link to={'/'}><img src='./images/home_screen_images/closes.svg' alt='close-img' className='close-icons' /></Link>Sign In</div>
                    {error && <Message>{error}</Message>}
                    <Form onSubmit={submitHandler}>

                        <div className='sign-in-row-one' controlId='email'>
                            <div className='google-sign'><img src='./images/home_screen_images/google.svg' alt='google-svg' className="google" />Continue with Google</div>
                            <input type='text' placeholder='Email Address' className="email-ad" value={email} onChange={(e) => setEmail(e.target.value)} />
                            <Link to={redirect ? `/register?redirect=${redirect}` : '/register'}>
                                <div className='user-reg'><img src='./images/home_screen_images/user-round.svg' alt='user-svg' className="user-round" />Create an account</div>
                            </Link>
                        </div>
                        ...
                        <div className='sign-in-row-three'>
                            <div className='sign-btn-grp'>
                                ...
                                <span className='checkbox-and-forgot-psw'><span><input type="checkbox" className='check-box' />Remember me</span><span>Forgot your password?</span></span>
                            </div>
                        </div>
                    </Form>
                </div>
