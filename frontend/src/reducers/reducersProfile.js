    ...
    switch (action.type) {
        ...
        case ADD_NEW_SHIPPING_ADDRESS:
            return {
                userProfile: {
                    ...state.userProfile,
                    shippingAddress: [...state.userProfile.shippingAddress , action.payload]
                } 
            }
        ...
        case EDIT_SHIPPING_ADDRESS:
            let updatedList = [...state.userProfile.shippingAddress];
            updatedList.splice(action.index, 1, action.payload);
            return {
                userProfile: {
                    ...state.userProfile,
                    shippingAddress: updatedList
                } 
            }
