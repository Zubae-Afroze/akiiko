...
export default function ReviewFormT() {
  ...
  const onPaymentFormSubmit = (e) => {
    ...
    const shippingPriceTemp =
      additionlaPriceTemp === 50
        ? 0
    ...
    return (
      <>
        <Col xs={10} className='p-0 m-0'>
          <div>
            <h6>
              {checkOutFormObj.formObject.firstName +
                ' ' +
                checkOutFormObj.formObject.lastName}
            </h6>
            <h6>{checkOutFormObj.formObject.address}</h6>
            <h6>
              {checkOutFormObj.formObject.city +
                '-' +
                checkOutFormObj.formObject.zipCode}
            </h6>
  ...
  function EncryptedCardNumber() {
    let lastFourNumbers = checkOutFormObj.formObject.cardNumber.substring(
      12,
      17
    )
    return (
