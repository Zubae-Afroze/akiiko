...
} from '../../screens/Stable Checkout Screen/CheckOutIndex'
...
export default function ShippingFormT() {
  ...
  const [changeShippingFormState, setChangeShippingFormState] = useState(
    checkOutFormObj.formObject
  )
  ...
  function onSubmitShippingForm(e) {
    ...
    if (
      checkOutFormObj.formObject.firstName === null ||
      checkOutFormObj.formObject.firstName.trim() === ''
    ) {
      updatedList[0] = true
      isValidated = false
    }
    ...
    if (
      checkOutFormObj.formObject.lastName === null ||
      checkOutFormObj.formObject.lastName.trim() === ''
    ) {
      updatedList[1] = true
      isValidated = false
    }
    if (
      checkOutFormObj.formObject.address === null ||
      checkOutFormObj.formObject.address.trim() === ''
    ) {
      updatedList[2] = true
      isValidated = false
    }
    if (
      checkOutFormObj.formObject.phoneNumber === null ||
      checkOutFormObj.formObject.phoneNumber.trim() === ''
    ) {
      updatedList[3] = true
      isValidated = false
    }
    if (
      checkOutFormObj.formObject.city === null ||
      checkOutFormObj.formObject.city.trim() === ''
    ) {
      updatedList[4] = true
      isValidated = false
    }
    if (
      checkOutFormObj.formObject.state === null ||
      checkOutFormObj.formObject.state.trim() === ''
    ) {
      updatedList[5] = true
      isValidated = false
    }
    if (
      checkOutFormObj.formObject.zipCode === null ||
      checkOutFormObj.formObject.zipCode.trim() === ''
    ) {
      updatedList[6] = true
      isValidated = false
    }
  ...
  return (
    <>
      {profileDetails && (
        <motion.div
          variants={formEntranceAnimation}
          initial='hidden'
          animate='visible'
        >
          <>
            <div
              className='forms-height'
...
function ReturnAddressForm({
  ...
  if (profileDetails === null || profileDetails.shippingAddress.length === 0) {
  ...
  if (
    ...
    !checkOutFormObj.formObject.isNewAddress
  ) {
    ...
    <>
          ...
          {profileDetails.shippingAddress.map((object, index) => {
            return (
              <Col xs={12} md={6} className='p-0 m-0'>
                <div
                  className={
                    'existing-address-component existing-address-' +
                    (index % 2 === 0 ? 'even' : 'odd') +
                    'Num-style'
                  }
                  onClick={() => {
                ...
                >
                  ...
                  <div className='f-f'>
                    <button
                      className='continue-with-this-address-btn'
      ...
      <div className='d-block d-sm-block d-md-none pt-3 f-f-l'>
        <div style={hrStyle.row}>
          <div style={hrStyle.block}>
            <hr style={{ borderColor: '#d6d6d6' }} />
          </div>
          <div style={hrStyle.blockCenter}>
            <h6 style={{ margin: 0, marginTop: 8, color: 'gray' }}>OR</h6>
          </div>
          <div style={hrStyle.block}>
            <hr style={{ borderColor: '#d6d6d6' }} />
          </div>
      ...
      <Col xs={6} lg={6} className='p-0 m-0'>
        <div className='left-side-field-style'>
          <Form.Control
            ...
            className={
              'd-block d-sm-none ' + (errorFields[0] ? 'error-form-style' : '')
            }
          />
          ...
          <Form.Control
            ...
            onChange={handelInputeChange}
            className={
              'd-none d-sm-block ' + (errorFields[0] ? 'error-form-style' : '')
            }
          />
        </div>
      </Col>
      ...
      <Col xs={6} lg={6} className='p-0 m-0'>
        <div className='right-side-field-style'>
          <Form.Control
            ...
            onChange={handelInputeChange}
            className={
              'd-block d-sm-none ' + (errorFields[1] ? 'error-form-style' : '')
            }
          />
          ...
          <Form.Control
            ...
            onChange={handelInputeChange}
            className={
              'd-none d-sm-block ' + (errorFields[1] ? 'error-form-style' : '')
            }
          />
        </div>
      </Col>
    ...
    <Col xs={12} lg={6} className='p-0 m-0'>
      <div className='address-field-style'>
        <Form.Control
          ...
          onChange={handelInputeChange}
          className={
            'd-block d-sm-none ' + (errorFields[2] ? 'error-form-style' : '')
          }
        />
        ...
        <Form.Control
          ...
          onChange={handelInputeChange}
          className={
            'd-none d-sm-block ' + (errorFields[2] ? 'error-form-style' : '')
          }
        />
      </div>
    </Col>
    ...
    <Col xs={6} lg={4} className='p-0 m-0'>
      <div className='city-field-style'>
        <Form.Control
          ...
          onChange={handelInputeChange}
          className={
            'd-block d-sm-none ' + (errorFields[4] ? 'error-form-style' : '')
          }
        />
        ...
        <Form.Control
          ...
          onChange={handelInputeChange}
          className={
            'd-none d-sm-block ' + (errorFields[4] ? 'error-form-style' : '')
          }
        />
      </div>
    </Col>
    ...
    <Col xs={6} lg={4} className='p-0 m-0'>
      <div className='pin-code-field-style test-pin-code'>
        <Form.Control
          ...
          onChange={handelInputeChange}
          className={
            'd-block d-sm-none ' + (errorFields[6] ? 'error-form-style' : '')
          }
        />
        ...
        <Form.Control
          ...
          onChange={handelInputeChange}
          className={
            'd-none d-sm-block ' + (errorFields[6] ? 'error-form-style' : '')
          }
        />
      </div>
    </Col>
