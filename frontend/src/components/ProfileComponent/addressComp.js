...
export default function AddressComp({
  ...
  function handelInputeChange(event) {
    setUpdateAddressObject((prevState) => ({
      ...prevState,
  ...
  function onSumbitForm(e) {
    ...
    if (
      updateAddressObject.firstname === null ||
      updateAddressObject.firstname.trim() === ''
    ) {
      updatedList[0] = true
      isValidated = false
    }
    if (
      updateAddressObject.lastname === null ||
      updateAddressObject.lastname.trim() === ''
    ) {
      updatedList[1] = true
      isValidated = false
    }
    if (
      updateAddressObject.address === null ||
      updateAddressObject.address.trim() === ''
    ) {
      updatedList[2] = true
      isValidated = false
    }
    if (
      updateAddressObject.mobile === null ||
      updateAddressObject.mobile.trim() === ''
    ) {
      updatedList[3] = true
      isValidated = false
    }
    if (
      updateAddressObject.city === null ||
      updateAddressObject.city.trim() === ''
    ) {
      updatedList[4] = true
      isValidated = false
    }
    if (
      updateAddressObject.state === null ||
      updateAddressObject.state.trim() === ''
    ) {
      updatedList[5] = true
      isValidated = false
    }
    if (
      updateAddressObject.zipCode === null ||
      updateAddressObject.zipCode.trim() === ''
    ) {
      updatedList[6] = true
      isValidated = false
    }
              ...
              <Row className='m-0 p-0'>
                ...
                >
                  <div style={{ marginRight: 7 }}>
                    <Form.Control //For Small Screens
                      ...
                      className={
                        'edit-form-style d-block d-sm-none ' +
                        (errorFields[0] ? 'error-form-style' : '')
                      }
                      name='firstname'
                    ...
                    <Form.Control //For Large Screens
                      ...
                      placeholder='First Name'
                      className={
                        'd-none d-sm-block edit-form-style ' +
                        (errorFields[0] ? 'error-form-style' : '')
                      }
                ...
                >
                  ...
                  <Form.Control
                    ...
                    className={
                      'd-block d-sm-none edit-form-style ' +
                      (errorFields[1] ? 'error-form-style' : '')
                    }
                    name='lastname'
                ...
                <Col xs={6} sm={6} md={6} className='p-0 mb-2'>
                  <Form.Control
                    ...
                    className={
                      'd-block d-sm-none edit-form-style ' +
                      (errorFields[3] ? 'error-form-style' : '')
                    }
                    name='mobile'
                ...
                >
                  ...
                  <Form.Control
                    ...
                    className={
                      'd-block d-sm-none edit-form-style ' +
                      (errorFields[5] ? 'error-form-style' : '')
                    }
                    name='state'
