    ...
    return (
        <Container>
            <div className='product-list-wrapper'>
                ...
                {tablewareLoading ? <MyComponent
                    sentences={[]}
                    wrapperBackgroundColor={'rgba(255,255,255)'}
                    color={'#6e4e37'}
                    loaderType={'ball-spin-clockwise'}
                    customLoader={<SpinnerIcon />}
                /> : tablewareError ? <h1>{tablewareError}</h1> : tablewareProducts[Object.keys(tablewareProducts)[0]] ?
                    <>
                ...
                {kitchenLoading ? <MyComponent
                    sentences={[]}
                    wrapperBackgroundColor={'rgba(255,255,255)'}
                    color={'#6e4e37'}
                    loaderType={'ball-spin-clockwise'}
                    customLoader={<SpinnerIcon />}
                /> : kitchenError ? <h1>{kitchenError}</h1> : kitchenProducts[Object.keys(kitchenProducts)[0]] ?
                    <>
                ...
                {laundryLoading ? <MyComponent
                    sentences={[]}
                    wrapperBackgroundColor={'rgba(255,255,255)'}
                    color={'#6e4e37'}
                    loaderType={'ball-spin-clockwise'}
                    customLoader={<SpinnerIcon />}
                /> : laundryError ? <h1>{laundryError}</h1> : laundryProducts[Object.keys(laundryProducts)[0]] ?
                    <>
                ...
                {gardenLoading ? <MyComponent
                    sentences={[]}
                    wrapperBackgroundColor={'rgba(255,255,255)'}
                    color={'#6e4e37'}
                    loaderType={'ball-spin-clockwise'}
                    customLoader={<SpinnerIcon />}
                /> : gardenError ? <h1>{gardenError}</h1> : gardenProducts[Object.keys(gardenProducts)[0]] ?
                    <>
