const HomeScreenHomeProducts = [
  {
    ...
    images: ['/images/p_images/Home/Kitchen/HK002/hero.jpg'],
    images_web: ['/images_web/Home/Kitchen/HK002/hero.jpg'],
    group: 'Home',
    subGroup: 'Kitchen',
    mrpPrice: '399',
    link: 'original-sandwich-bag',
  },
  {
    ...
    images: ['/images/p_images/Home/Kitchen/HK008/hero.jpg'],
    images_web: ['/images_web/Home/Kitchen/HK008/hero.jpg'],
  ...
  },
  {
    ...
    images: ['/images/p_images/Home/Laundry/HL005/hero.jpg'],
    images_web: ['/images_web/Home/Laundry/HL005/hero.jpg'],
    hoverImage: '',
    group: 'Home',
    subGroup: 'Laundry',
  ...
  },
  {
    ...
    images: ['/images/p_images/Home/Laundry/HL006/hero.jpg'],
    images_web: ['/images_web/Home/Laundry/HL006/hero.jpg'],
    hoverImage: '',
    group: 'Home',
    subGroup: 'Laundry',
    mrpPrice: '1199',
  ...
  },
  {
    ...
    images: ['/images/p_images/Home/Laundry/HL008/hero.jpg'],
    images_web: ['/images_web/Home/Laundry/HL008/hero.jpg'],
  ...
  },
  {
    ...
    images: ['/images/p_images/Home/Tableware/HT002/hero.jpg'],
    images_web: ['/images_web/Home/Tableware/HT002/hero.jpg'],
    hoverImage: '',
    group: 'Home',
    subGroup: 'Tableware',
    bestSeller: 'New Arrival',
